...
function et_setup_theme() {
	...
	wp_enqueue_style( 'bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css' );
...
class wpcf7_dynamic_mail_to_examples {
	...
	private $email_address_1 = 'daniel.shafer@jewsforjesus.org';
	private $email_address_2 = 'daniel.shafer@jewsforjesus.org';
	private $email_address_3 = 'daniel.shafer@jewsforjesus.org';
...
function wpcf7_dynamic_to_filter_example() {
	if (isset($args['select-email'])) {
		if ($args['select-email'] == 'send to email 1') {
			$recipient = 'daniel.shafer@jewsforjesus.org';
		} elseif ($args['select-email'] == 'send to email 2') {
			$recipient = 'daniel.shafer@jewsforjesus.org';
