<?php
// This is a clone of the apiCall.php in plugins/event_search
//yokida 5/31/2016 sample code to make an API call to BBEC
	...
	?>
		...
		<script type="text/javascript">
			...
			function shortcodeSearchFML(searchType, resource_name, distance = '25') {
			var eventArray = [];
				...
				return $.ajax({
					type: "POST",
					url: "http://dev01.jewsforjesus.org/wp-content/themes/Divi/apiCallFML.php",
					dataType: 'json',
					data: 	{
