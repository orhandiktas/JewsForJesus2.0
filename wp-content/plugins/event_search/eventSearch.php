...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	<head>
		...
		<link type="text/css" rel="stylesheet" href="http://dev01.jewsforjesus.org/wp-content/themes/jews-for-jesus/scss.css">
	...
	<div class="event-search-forms row">
		<form class="col-sm-3" id="frmEventSearch" action="" method="post">			
			<select id="ddlPrograms" style="width: 220px;">
				<option value="All programs">All programs</option>				
				<input style="display:none;" id="btnSearch" type="button" class="btn btn-success" value="Program Search" />
		</form>
		<form class="col-sm-3" id="countryEventSearch" action="" method="post">
			<select id="countryDdlPrograms" style="width: 220px;">
				...
				<input style="display:none;" id="countryBtnSearch" type="button" class="btn btn-success" value="Country Search" />
		</form>
		<form class="col-sm-3" id="mishFrmEventSearch" action="" method="post">
			<select id="mishDdlPrograms" style="width: 220px;">
				<option value="All speakers">All speakers</option>
				<input style="display:none;" id="mishBtnSearch" type="button" class="btn btn-success" value="Speaker Search" />
		</form>
		<form class="col-sm-3" id="keywordsFrmEventSearch" action="" method="post">
			<input type="text" id="keywordsDdlPrograms" style="width: 220px;">
			<input style="display:none;" id="keywordsBtnSearch" type="button" class="btn btn-success" value="Keyword Search" />
		</form>
	</div>
</body>
</html>
