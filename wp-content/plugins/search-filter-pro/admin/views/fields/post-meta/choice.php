				...
				<p class="item-container choice_order_options" style="padding-right:0;">
					<label for="{0}[{1}][choice_order_option_by]"><?php _e("Order Options by: ", $this->plugin_slug); ?><br />
						<select name="{0}[{1}][choice_order_option_by]" class="" id="{0}[{1}][choice_order_option_by]">
						...
						<select name="{0}[{1}][choice_order_option_dir]" class="" id="{0}[{1}][choice_order_option_dir]">
						...
						<select name='{0}[{1}][choice_order_option_type]' id="{0}[{1}][choice_order_option_type]">
