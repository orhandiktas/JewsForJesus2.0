...
class Search_Filter_Active_Query {
	...
	public function get_post_meta($sf_post_meta_key, $labels = array())
	{
		...
		$sf_post_meta_key_get = str_replace(" ", "_", $sf_post_meta_key); //replace space with `_` as this is done anyway - spaces are not allowed in GET variable names, and are automatically converted by server/browser to `_`
